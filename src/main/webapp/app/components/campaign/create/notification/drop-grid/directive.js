(function () {
    ...
    app.directive('dropGrid', function ($timeout, fileReader, $uibModal) {
        return {
            restrict: 'E',
            scope: {
                image: '=',
            ...
            templateUrl: 'app/components/campaign/create/notification/drop-grid/template.html',
            link: function (scope, element, attribute) {
                ...
                //                     var preImages = [
                //                     { imageSrc: 'images/png/car.png', imgtype: 'pre' },
                //                     { imageSrc: 'images/png/cup.png', imgtype: 'pre' },
                //                     { imageSrc: 'images/png/diamond.png', imgtype: 'pre' },
                //                     { imageSrc: 'images/png/plan.png', imgtype: 'pre' },
                //                     { imageSrc: 'images/png/pil.png', imgtype: 'pre' },
                //                     { imageSrc: 'images/png/globe.png', imgtype: 'pre' },
                //                     { imageSrc: 'images/png/iopush-gift.png', imgtype: 'pre' }
                // //                    { imageSrc: 'images/png/gift.png', imgtype: 'pre' },
                // //                    { imageSrc: 'images/png/hanger.png', imgtype: 'pre' },
                // //                    { imageSrc: 'images/png/mobile-phone.png', imgtype: 'pre' },
                // //                    { imageSrc: 'images/png/padnote.png', imgtype: 'pre' },
                ...
                // scope.images = preImages.slice(0, 7);
                ...
                function convertImageToFile(url) {
                    var xhr = new XMLHttpRequest();
                    xhr.open('GET', 'blob:https://' + window.location.host + '/' + url, true);
                ...
                scope.selectImage = function (image) {
                    ...
                    if (image.imgtype === "custom") {
                        ...
                        convertImgToDataURLviaCanvas('https://' + window.location.host + '/iopush/' + image.imageSrc, function (data) {
